  ...
  if (status === 'success') return (
    <main className="min-h-screen flex items-center justify-center bg-emerald-50 p-4">
      <div className="bg-white rounded-2xl shadow-xl p-8 text-center max-w-md">
        ...
        <p className="text-gray-700 mb-3 font-medium">Thank you! Our team will review your service listing.</p>
        <p className="text-gray-600 mb-6 text-sm">
          Once approved (usually within 24 hours), your service will be live on the Connect2Kehilla SMS directory.
        </p>
